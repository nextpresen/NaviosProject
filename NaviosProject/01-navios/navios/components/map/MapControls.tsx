  ...
  return (
    <div className="absolute bottom-6 right-4 z-[1000] flex flex-col gap-2">
      <button
        ...
        className="h-11 rounded-2xl bg-white/85 backdrop-blur-xl border border-white/60 shadow-lg flex items-center gap-2 px-3 hover:bg-white transition"
        title="現在地"
      >
      ...
      >
        ...
        <span className="text-xs font-semibold text-slate-700">全体表示</span>
      </button>
    </div>
  );
}
